...
class SettingController extends AdminBaseController
{
    ...
    public function site()
    {
		...
		$this->assign("wx_settings", $wxSettings);
		$this->assign("sms_settings", $smsSettings);
    ...
    public function sitePost()
    {
        if ($this->request->isPost()) {
			...
			$wxSettings = $this->request->param('wx_settings/a');
            cmf_set_option('wx_settings', $wxSettings);
			
			$smsSettings = $this->request->param('sms_settings/a');
            cmf_set_option('sms_settings', $smsSettings);
